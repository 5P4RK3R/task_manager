...
import { selectTask,fetchTasks,fetchUsers} from '../storeManager/slices/taskSlice';
const Home = ({auth}) => {
  ...
  return (
    <div className='container mx-auto'>
        ...
        <Task users ={users} taskDetail={taskDetail} index={index} id={taskDetail.id} auth={auth}/>
        ))}
    </div>
  )
}
